...
public class CompletedOrders extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        loadCompletedOrdersList();

    }

    private void loadCompletedOrdersList() {
        mDatabase.child("orders").addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                if (dataSnapshot != null) {
                    ...
                    if (orderModel != null) {
                        if (orderModel.getOrderStatus().equals("Order completed")) {
...
//                        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = (RecyclerView) rootView.findViewById(R.id.recycler_completed_orders);

package com.appsinventiv.freewatchadmin.Fragments;
...
import com.appsinventiv.freewatchadmin.Adapters.OrdersAdapter;
...
public class ShippedOrders extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        loadShippedOrdersList();


    }

    private void loadShippedOrdersList() {
        mDatabase.child("orders").addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                if (dataSnapshot != null) {
                    ...
                    if (orderModel != null) {
                        if (orderModel.getOrderStatus().equals("Order shipped")) {
...
//                        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View  rootView = inflater.inflate(R.layout.fragment_shipped_orders, container, false);


        recyclerView = (RecyclerView) rootView.findViewById(R.id.recycler_shipped_orders);

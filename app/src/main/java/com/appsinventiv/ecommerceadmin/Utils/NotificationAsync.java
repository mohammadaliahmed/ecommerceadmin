...
public class NotificationAsync extends AsyncTask<String, String, String> {
    ...
    public final static String AUTH_KEY_FCM_LIVE = "AAAAvqjlvwQ:APA91bEpGgRhsBlWGD_3AhoPuxaCcrFnFqUTluvIv53yO-fyy5cmKeo4j5BP3zrxjXmh0Fj2epTzKxQNUPaWq5a3Jhmh6WkKCAAJnjAECZrssbH89wJyKAjNG9mmJBQ9iBsvulHjWLVW";

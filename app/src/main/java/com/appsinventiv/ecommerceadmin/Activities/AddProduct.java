...
import com.appsinventiv.ecommerceadmin.Adapters.SelectedImagesAdapter;
import com.appsinventiv.ecommerceadmin.Models.PictureModel;
import com.appsinventiv.ecommerceadmin.Models.ProductModel;
import com.appsinventiv.ecommerceadmin.Models.SelectedAdImages;
import com.appsinventiv.ecommerceadmin.R;
import com.appsinventiv.ecommerceadmin.Utils.GifSizeFilter;
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (et_title.getText().toString().length() == 0) {
                    ...
                    et_weight.setError("Cannot be null");
                    ...
                    itemWeight = Float.parseFloat(et_weight.getText().toString());
...
//                    Toast.makeText(AddProduct.this, "Correct", Toast.LENGTH_SHORT).show();
                    ...
                    mDatabase.child("products").child(productId).setValue(new ProductModel(productId, itemTitle, subTitle, itemPrice, itemDescription, itemSpecification, "", itemWeight, itemColor,itemQuantity, sku, "yes", time));
                    int number=0;
